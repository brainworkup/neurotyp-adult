...
`r params$first_name`'s broad academic achievement and academic fluency skills fell
in the Average range for `r params$his_her` age and grade-level. Math fluency, math
...
differences between `r params$first_name`'s predicted scores (based on `r params$his_her`
cognitive ability) and the scores `r params$he_she` actually obtained on measures of
reading achievement. While reading comprehension stood out as a strength, there
were 21-25 point discrepancies between `r params$his_her` predicted and obtained
...
memory capacity contributes to `r params$first_name`'s low reading scores and very
