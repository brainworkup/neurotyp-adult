...
groups_standard_score <- c("CEFI Self-Report", "CEFI Observer-Report")
groups_t_score <- c("CAARS Self-Report", "CAARS Observer-Report")

adhd <- bwu::table_gt(data,
  pheno = pheno,
  table_name = table_name,
  vertical_padding = 0.10,
  groups_standard_score = groups_standard_score,
  groups_t_score = groups_t_score,
  groups_scaled_score = NULL,
  multiline = TRUE
)
```
