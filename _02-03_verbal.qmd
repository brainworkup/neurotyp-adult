...
verbal <- verbal |> dplyr::filter(domain == domains)
...
grp_verbal <- list(
  scaled_score = c("WAIS-IV", "WISC-5", "NEPSY-2", "D-KEFS", "WPPSI-IV"),
  # standard_score = c("NAB", "WPPSI-IV", "NAB-S"),
  t_score = c("NAB", "NIH EXAMINER", "WASI-2")
)

Line 6unexpected end of document
bwu::tbl_gt(
  data = data_verbal,
  pheno = pheno,
