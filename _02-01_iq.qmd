...
grp_iq <- list(
  standard_score = c(
    ...
    "WAIS-IV", "WAIS-4", "WISC-5", "WASI-2", "RBANS", "KTEA-3"
  )
)
vertical_padding <- 0
multiline <- TRUE
    ...
    grid(
      ...
      gutter: 8pt,
        ...
        figure([#image(file_fig, width: auto)],
          caption: figure.caption(position: bottom, [_General Ability_ refers
          to an overall capacity to reason, to solve problems, and to learn
          useful information. _Crystallized Knowledge_ involves understanding the world through language and reasoning. _Fluid Reasoning_ is the logical analysis and solution of new problems, identifying underlying patterns, and applying logic.
          ]),
          placement: none,
          kind: "image",
          supplement: [Fig.],
