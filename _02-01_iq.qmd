...
grp_iq <- list(
  standard_score = c(
    ...
    "WAIS-IV", "WAIS-4", "WISC-5", "WASI-2", "RBANS"
  )
)
vertical_padding <- 0
multiline <- TRUE
...
iq <-
  dplyr::filter(
    ...
    scale %in% c(
      ...
      "Premorbid Ability", "TOPF Standard Score", "Word Reading", "NAB Executive
      Functions Index", "Verbal Comprehension (VCI)", "Perceptual Reasoning (PRI)"
    )
  )
      ...
      gutter: 8pt,
        ...
        figure([#image(file_fig, width: auto)],
          caption: figure.caption(position: bottom, [
            _Premorbid Ability_ is an estimate of intellectual functioning prior
            to known or suspected onset of brain disease or dysfunction.
            _Neuropsychological Functioning_ is the overall skill to reason,
            solve problems, and gain useful knowledge.
            ]),
          placement: none,
          kind: "image",
          supplement: [*Fig.*],
