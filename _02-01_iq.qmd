...
iq <- iq |> dplyr::filter(domain == domains)

# Select specific columns from the data frame
iq <- iq |> dplyr::select(
  test, test_name, scale, raw_score, score, ci_95, percentile, range,
  ...
  z_mean_verbal, z_sd_verbal, z_mean_timed, z_sd_timed, description, result
)
