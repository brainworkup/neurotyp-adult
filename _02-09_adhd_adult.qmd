...
# Flatten the text
bwu::cat_neuropsych_results(data = data_adhd_self, file = "_02-09_adhd_adult_text.qmd")
```
...
data_adhd_observer <-
  ...
  dplyr::distinct(.keep_all = FALSE)
# Flatten the text
bwu::cat_neuropsych_results(data = data_adhd_observer, file = "_02-09_adhd_adult_text.qmd")
```
