...
Results from formal tests are reported in comparison to other individuals the same age and sex/gender as range of functioning (e.g., Below { range }, { range }, Above { range }).[@guilmetteAmericanAcademyClinical2020]
