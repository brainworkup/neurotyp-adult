...
# saveRDS(file, "caars2.rds")
# input_file_path <- readRDS("caars2.rds")
...
plucked_tables_caars2 <- tabulapdf::extract_tables(
  file = file,
  pages = pages,
  output = "matrix",
  method = "stream",
...
save(plucked_tables_caars2, file = "plucked_tables_caars2.RData")

# Load the entire list from an R data file
load("plucked_tables_caars2.RData")
```
...
# Example Usage:
process_caars2_tables(plucked_tables_caars2)

# Loop over the list and write each matrix to a CSV file
for (i in seq_along(plucked_tables_caars2)) {
  write.csv(plucked_tables_caars2[[i]], file = paste0(test, "_", i, ".csv"), row.names = FALSE)
}
```
...
plucked_tables <- plucked_tables_caars2
...
table <-
  ...
  dplyr::mutate(
    narrow = dplyr::case_when(
      scale ==
        "Inattention/Executive Dysfunction" ~ "Inattention",
      scale ==
        "Hyperactivity" ~ "Hyperactivity",
      scale ==
        "Impulsivity" ~ "Impulsivity",
      scale ==
        "Emotional Dysregulation" ~ "Self-Concept",
      scale ==
        "Negative Self-Concept" ~ "Self-Concept",
      scale ==
        "ADHD Inattentive Symptoms" ~ "Inattention",
      scale ==
        "ADHD Hyperactive/Impulsive Symptoms" ~ "Hyperactivity",
      scale ==
        "Total ADHD Symptoms" ~ "Combined Symptoms",
      scale ==
...
if (params$test == "caars2_sr") {
  table <-
    ...
    dplyr::mutate(
      result = dplyr::case_when(
        scale == "Self-reported Inattention/Executive Dysfunction" ~ glue::glue(
          "- {scale} ({description}) was {range}.\n\n"
        ),
        scale == "Self-reported Hyperactivity" ~ glue::glue(
          "- {scale} ({description}) was {range}.\n\n"
        ),
        scale == "Self-reported Impulsivity" ~ glue::glue(
          "- {scale} ({description}) was {range}.\n\n"
        ),
        scale == "Self-reported Emotional Dysregulation" ~ glue::glue(
          "- {scale} ({description}) was {range}.\n\n"
        ),
        scale == "Self-reported Negative Self-Concept" ~ glue::glue(
          "- {scale} ({description}) was {range}.\n\n"
        ),
        scale == "Self-reported ADHD Inattentive Symptoms" ~ glue::glue(
          "- {scale} ({description}) was {range}.\n\n"
        ),
        scale == "Self-reported ADHD Hyperactive/Impulsive Symptoms" ~ glue::glue(
          "- {scale} ({description}) was {range}.\n\n"
        ),
        scale == "Self-reported Total ADHD Symptoms" ~ glue::glue(
          "- {scale} ({description}) was {range}.\n\n"
        ),
        scale == "Self-reported ADHD Index" ~ glue::glue(
  ...
  table <-
    ...
    dplyr::mutate(
      result = dplyr::case_when(
        scale == "Observer reported Inattention/Executive Dysfunction" ~ glue::glue(
          "- {scale} ({description}) was {range}.\n\n"
        ),
        scale == "Observer reported Hyperactivity" ~ glue::glue(
          "- {scale} ({description}) was {range}.\n\n"
        ),
        scale == "Observer reported Impulsivity" ~ glue::glue(
          "- {scale} ({description}) was {range}.\n\n"
        ),
        scale == "Observer reported Emotional Dysregulation" ~ glue::glue(
          "- {scale} ({description}) was {range}.\n\n"
        ),
        scale == "Observer reported Negative Self-Concept" ~ glue::glue(
          "- {scale} ({description}) was {range}.\n\n"
        ),
        scale == "Observer reported ADHD Inattentive Symptoms" ~ glue::glue(
          "- {scale} ({description}) was {range}.\n\n"
        ),
        scale == "Observer reported ADHD Hyperactive/Impulsive Symptoms" ~ glue::glue(
          "- {scale} ({description}) was {range}.\n\n"
        ),
        scale == "Observer reported Total ADHD Symptoms" ~ glue::glue(
          "- {scale} ({description}) was {range}.\n\n"
        ),
        scale == "Observer reported ADHD Index" ~ glue::glue(
