...
markdown_table_typst <- function(data) {
  data.frame(
    ...
    kableExtra::kbl(
      ...
      linesep = "",
      align = c("lccc"),
      caption = "Attentional and Executive Functions",
...
#| label: csv-executive
#| eval: false
executive <- data[, c(2, 4, 5, 6)]
readr::write_csv(executive, "executive.csv", col_names = FALSE)
```
