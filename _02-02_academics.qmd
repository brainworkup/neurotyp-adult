...
# Remove rows where 'x2' or 'y2' is NA
data_academics <- na.omit(data_academics, cols = c("z_mean_subdomain", "subdomain"))
...
# Remove rows where 'x2' or 'y2' is NA
data_academics <- na.omit(data_academics, cols = c("z_mean_narrow", "narrow"))
