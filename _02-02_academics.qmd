  ...
  grid(
    ...
    figure(
      ...
      caption: figure.caption(
        position: bottom,
        [
          Reading ability encompasses three interconnected skills: _Decoding_: The capacity to identify and pronounce isolated written words; _Comprehension_: The aptitude to understand explicit facts in the text as well as infer unstated aspects; _Fluency_: The proficiency in swiftly and fluently decoding and understanding basic written information.
        ],
      ),
      placement: none,
      kind: "image",
