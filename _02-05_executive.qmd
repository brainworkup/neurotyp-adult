...
executive <- readr::read_csv("neurocog.csv") |>
  ...
  dplyr::select(
    scale, score, z, percentile, range, test_name, domain, subdomain, narrow, pass, verbal, timed, result, z_mean_domain, z_sd_domain, z_mean_subdomain,
...
# data_executive <- dplyr::filter(data = data_executive, test_name != "CVLT-3 Brief") |>
