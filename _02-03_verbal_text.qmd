...
Ability to name objects and actions fell within the Above { range }.
{{< var patient >}}'s Comprehension of Instructions score of 14 () is classified as Above { range } and is ranked at the 91th percentile, indicating performance as good as or better than 91% of same age peers from the general population. This estimate of Receptive language processing and the ability to follow multistep instructions is considered a relative neurocognitive strength.
General knowledge and ability to recall and understand information fell within the { range }.
Receptive language ability, vocabulary development, and ability to understand and use words fell within the { range }.
