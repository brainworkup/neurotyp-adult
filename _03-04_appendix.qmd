...
#       align = c("cccccc"),
#       col.names = c(
#         "**Score Range**", "**Standard Score**", "**T-Score**",
#         "**Scaled Score**", "**z-Score**", "**‰ Rank**"
#       ),
#       caption = caption
#     )
...
df <- readr::read_csv("test_score_ranges.csv")
knitr::kable(df, align = c("cccccc"), caption = "Test Score Labels/Ranges")
# tbl_md_typ(data = df, caption = "Test Score Labels/Ranges")
```
