...
xfun::pkg_load2(
  c(
    ...
    "htmlwidgets", "janitor", "knitr", "magick", "manipulateWidget", "png",
    "quarto", "readxl", "rmarkdown", "scales", "snakecase", "stats", "svglite",
...
if (is.null(return_plot)) return_plot <- FALSE
if (return_plot == "true") return_plot <- TRUE
if (is.null(patient)) patient <- "Biggie"
```

```{r}
#| label: data-load
#| include: false
bwu::load_data(here::here("."))
```
