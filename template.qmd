...
#| include: false
xfun::pkg_load2(
  c("fs", "ggtext", "ggthemes", "glue", "gt", "gtExtras", "hablar", "here", "highcharter", "htmlwidgets", "janitor", "knitr", "magick", "manipulateWidget", "pdftools", "png", "quarto", "readxl", "rmarkdown", "scales", "shiny", "snakecase", "stats", "svglite", "tabulizer", "tidyselect", "tidytext", "tidyverse", "webshot2", "widgetframe", "xfun", "yaml", "bwu")
)
```
